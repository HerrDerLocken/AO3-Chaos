...
(function () {
  ...
  const LOCATION_POOL = [
    ...
    ['In Line at TSA, Reconsidering Everything',              [33.94, -118.40]],
    ['A Target Parking Lot During Golden Hour',               [44.95,  -93.09]],
    ['The Group Chat After Saying "hear me out"',             [40.76,  -73.98]],
    ['A Motel 6 With Questionable Vibes',                     [36.17, -115.14]],
    ['The Last Car of the Subway',                            [34.05, -118.25]],
    ['A Denny\'s Booth (emotionally exposed)',                [32.78,  -96.80]],
    ['On Hold with Customer Service (42 mins)',               [39.95,  -75.16]],
    ['A College Lecture Hall in the Back Row',                [42.35,  -71.10]],
    ['The Renaissance Faire (in full costume)',               [47.61, -122.33]],
    ['A Beach Episode That Went Wrong',                       [25.76,  -80.19]],
    ['The IKEA Food Court (lingonberry era)',                 [59.33,   18.07]],
    ['A Costco Aisle Next to the 48-Pack Snacks',             [49.28, -123.12]],
    ['The Bathroom at a Wedding Reception',                   [35.22,  -80.84]],
    ['An Uber Pool With 3 Strangers Judging Them',            [38.90,  -77.04]],
    ['A Camping Trip With No Signal (they found signal)',     [39.74, -104.99]],
    ['The Middle Seat on a Red-Eye Flight',                   [40.64,  -73.78]],
    ['A High School Reunion They Shouldn\'t Have Attended',   [41.26,  -95.93]],
    ['The Kitchen at 1:47am Eating Shredded Cheese',          [39.10,  -94.58]],
    ['An Art Museum Bench, Pretending to Reflect',            [38.89,  -77.02]],
    ['A Zoom Call With the Camera "Off"',                     [37.78, -122.41]],
    ['A Rooftop Party They Weren\'t Invited To',              [34.07, -118.36]],
    ['The Local Aquarium Touch Tank (emotional)',             [32.72, -117.16]],
    ['A Road Trip Rest Stop in the Rain',                     [36.85,  -76.29]],
    ['A Group Project Meeting That Could\'ve Been an Email',  [33.75,  -84.39]],
    ['The Back Row of a Movie Theater at Premiere Night',     [34.10, -118.33]],
    ['A Friend\'s Couch During a "Short Stay"',               [45.52, -122.68]],
    ['A Tech Conference They Don\'t Understand',              [37.33, -121.89]],
    ['A Balcony at 2am, Staring Dramatically',                [43.07,  -89.40]],
    ['The Afterparty of an Episode That Hurt Them',           [51.50,  -0.13]],
    ['A Farmer\'s Market Buying Emotional Support Bread',     [45.51, -122.66]],
  ];
  ...
  const FAKE_NAMES = [
    ...
    'CanonIsTemporary', 'SlowBurnApologist', 'AO3Archaeology',
    'KudosGremlin', 'EmotionalSupportWIP', 'BetaReadOrElse',
    'PlotTwistApplier', 'ThirdActBreakdown', 'SobbingSoftly',
    'ThisIsntAngstISwear', 'SelfInsertSupreme', 'UnreliableNarratorIRL',
    'RedStringConspiracy', 'LateNightUploader', 'FixItFicDealer',
    'SoftLaunchVillain', 'TheRealCliffhanger', 'DialogueAddict',
    'TagsAreMyLoveLanguage', 'DraftSevenAndCounting',
    'ReaderInsertRoyalty', 'VillainApologist', 'CanonDivergenceEnjoyer',
    'FoundFamilyCEO', 'EmotionallyAttached404', 'AO3Anthropologist',
    'ShipItOrElse', 'RewriteTheFinale', 'TinfoilHatTheorist',
    'KeyboardSmashAuthor', 'MainPairingDefender', 'SideCharacterStan',
    'PiningProfessionally', 'CommentSectionLurker',
    'AngstWithAHappyEnding', 'UnhingedButPolite',
    'SoftForNoReason', 'WorldbuildingAccident', 'AccidentalForeshadowing',
  ];
  ...
  const FAKE_AGES = [
    ...
    '19 (but spiritually 80)',
    '24 (quarter-life crisis deluxe)',
    '28 (refuses to elaborate)',
    '32 (still can\'t cook rice)',
    '35 (thriving? debatable.)',
    '41 (fandom elder status unlocked)',
    'Timeless (like unresolved plot threads)',
    'Old enough to remember dial-up fanfic',
    'Emotionally paused at 15',
  ...
  const FAKE_JOBS = [
    ...
    'Chaos Theory Researcher (field work ongoing)',
    'Full-Time Overthinker',
    'Assistant to the Regional Fandom Manager',
    'Professional Cliffhanger Installer',
    'Lore Archivist (self-appointed)',
    'Fanon Expansion Specialist',
    'Continuity Error Enthusiast',
    'Dialogue Polisher (overpolished)',
    'Metaphor Overuser',
    'Freelance Angst Distributor',
    'Head of Emotional Logistics',
    'Shipping Coordinator',
    'Senior Mutual Pining Consultant',
    'Beta Reader Escapee',
    'Tag Taxonomist',
    'Timeline Repair Technician',
    'Subtext Interpreter',
    'Headcanon Engineer',
    'Character Development Contractor',
    'Redemption Arc Strategist',
    'Fix-It Department Intern',
    'Director of Unnecessary Slow Burns',
    'Alternate Universe Architect',
    'Backstory Excavator',
    'Professional Gaslighter (of canon only)',
    'Romance Logistics Planner',
    'Conflict Escalation Analyst',
    'Resolution Withholder',
    'CEO of Making It Worse Before It Gets Better',
    'Angst & Sons LLC',
    'Plot Device Mechanic',
    'Side Quest Manager',
    'Emotional Continuity Supervisor',
    'Fandom Data Scientist (vibes-based)',
    'Slow Burn Project Manager',
    'Unpaid Intern of the Muse',
    'Creative Writing Goblin (tenured)',
    'Meta Commentary Specialist',
    'Exposition Smuggler',
    'Scene Transition Consultant',
  ];
  const FAKE_SEXUALITIES = [
    ...
    'Demisexual (but only for enemies-to-lovers)',
    'Pansexual (except for bad writing)',
    'Bi but make it fictional',
    'Aromantic (romantic about ships)',
    'Gay for that one villain specifically',
    'Questioning (the narrative choices)',
    'Omnisexual (omnivorous for angst)',
    'Straight? In this fandom?',
    'Emotionally unavailable except for 2D men',
    'Attracted to slow burns exclusively',
  ];
  const FAKE_MENTAL_ILLNESSES = [
    ...
    'Chronic Cliffhanger Compulsion',
    'Compulsive Canon Rewriter',
    'Severe Found Family Dependency',
    'Terminal Enemies-to-Lovers Brainrot',
    'Dialogue Echo Syndrome',
    'Intrusive AU Thoughts',
    'Slow Burn Patience Deficit',
    'Romantic Subplot Hypervigilance',
    'Excessive Italics Usage Disorder',
    'Flashback Overproduction',
    'Headcanon Hoarding',
    'Unfinished Series Grief',
    'Paragraph Break Anxiety',
    'Overtagging Impulse',
    'Fan Theory Delusion (affectionate)',
    'Emotional Damage Replay Disorder',
    'Uncontrolled Hurt/Comfort Urges',
    'Metaphor Inflation Condition',
    'Secondhand Embarrassment Overload',
    'Chronic Comment Refresh Syndrome',
  ];
